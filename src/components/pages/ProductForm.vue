<template>
  <form @submit.prevent="$emit('submitForm')"
    class="bg-[var(--Color-Surface-Surface-Primary)] dark:bg-[var(--Color-Surface-Surface-Primary)] border border-[var(--Color-Boarder-Border-Primary)] rounded-xl shadow-sm px-6 py-4  mx-auto mt-8 space-y-4">
    <h2 class="text-2xl font-medium text-center text-[var(--Color-Text-Text-Primary)] mb-4 font-nunito ">
    ...
    <div class="mb-4">
      ...
      <input
        ...
        class="w-full px-4 py-2 rounded-lg text-[var(--Color-Text-Text-Secondary)] dark:text-[var(--Color-Text-Text-Secondary)] border border-[var(--Color-Boarder-Border-Primary)] dark:border-[var(--Color-Boarder-Border-Primary)] bg-[var(--Color-Surface-Surface-Primary)] dark:bg-[var(--Color-Surface-Surface-Primary)] focus:outline-none focus:ring-2 focus:ring-[var(--Colors-Primary-500)] font-nunito"
        required
      />
    </div>
    <!-- Image Upload -->
    <div class="mb-4">
      ...
      <input
        ...
        accept="image/*"
        class="w-full px-4 py-2 rounded-lg border border-[var(--Color-Boarder-Border-Primary)] dark:border-[var(--Color-Boarder-Border-Primary)] bg-[var(--Color-Surface-Surface-Primary)] dark:bg-[var(--Color-Surface-Surface-Primary)] text-[var(--Color-Text-Text-Secondary)] dark:text-[var(--Color-Text-Text-Secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--Colors-Primary-500)] font-nunito"
      />
      <div v-if="form.image" class="mt-3">
        <img :key="form.image" :src="form.image" :alt="$t('productImage')" class="h-36 w-full object-cover rounded-lg border border-[var(--Color-Boarder-Border-Primary)] dark:border-[var(--Color-Boarder-Border-Primary)]" />
      </div>
