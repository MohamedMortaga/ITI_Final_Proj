<template>
  <div class="container mx-auto px-4 md:px-6 lg:px-[88px] mt-12 flex flex-col lg:flex-row gap-8">
    <!-- Text content on left -->
    <div class="flex-1">
      <h3 class="text-xl font-bold mb-4 text-[var(--Color-Text-Text-Brand)]">
        {{$t('whyRento')}} <span class="text-[var(--Color-Text-Text-Primary)]">Rento?</span>
      </h3>
