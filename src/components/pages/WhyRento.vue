<template>
  <div class="container mx-auto px-4 mt-8 mb-16">
    <!-- Centered title -->
    <h3 class="text-center text-3xl lg:text-4xl font-bold mb-8">
      <span class="text-[var(--Color-Text-Text-Primary)]">{{$t('why')}} </span>
      <span class="text-[var(--Color-Text-Text-Brand)]">{{ $t(`Rento`) }}</span>
    </h3>
