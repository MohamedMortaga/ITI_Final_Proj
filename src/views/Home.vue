...
<div class="w-full border-b border-[var(--Color-Surface-Surface-Tertiary)] bg-transparent">
    ...
    <div class="container mx-auto px-4 mt-8">
      <div class="flex items-center justify-between mb-4">
        <h2 class="text-xl font-bold text-[var(--Color-Text-Text-Primary)]">Recommended for you</h2>
        <a href="#" class="text-[var(--Color-Text-Text-Brand)] font-medium hover:underline">View All</a>
      </div>
  ...
  >
    ...
    <div class="container mx-auto px-4 mt-12">
      ...
      <div class="flex flex-col lg:flex-row gap-6 justify-center">
        <div class="bg-[var(--Color-Surface-Surface-Tertiary)] border border-[var(--Color-Boarder-Border-Primary)] rounded-xl p-6 flex-1 max-w-md mx-auto">
          ...
          <p class="text-sm mb-4">"The drill was clean and fully charged. I used it to install shelves at home and it worked flawlessly. Highly recommended!"</p>
        ...
        <div class="bg-[var(--Color-Surface-Surface-Tertiary)] border border-[var(--Color-Boarder-Border-Primary)] rounded-xl p-6 flex-1 max-w-md mx-auto">
          ...
          <p class="text-sm mb-4">"Honestly, I didn't expect it to be this powerful! I used it to drill into concrete walls for curtain rods, and it handled it like a pro."</p>
          <div class="flex items-center gap-2">
            <img src="@/assets/logo.png" alt="user" class="w-8 h-8 rounded-full object-cover" />
            <div>
        ...
        <div class="bg-[var(--Color-Surface-Surface-Tertiary)] border border-[var(--Color-Boarder-Border-Primary)] rounded-xl p-6 flex-1 max-w-md mx-auto">
          ...
          <p class="text-sm mb-4">"Great tool, easy to use even for someone with no experience. I used it to assemble my IKEA wardrobe and it saved me hours!"</p>
          <div class="flex items-center gap-2">
            <img src="@/assets/logo.png" alt="user" class="w-8 h-8 rounded-full object-cover" />
            <div>
      ...
      <div class="flex justify-center mt-6 gap-2">
        <button class="w-8 h-8 rounded-full border border-[var(--Color-Boarder-Border-Primary)] flex items-center justify-center text-[var(--Color-Text-Text-Brand)] hover:bg-[var(--Color-Surface-Surface-Brand]">
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <div class="text-sm text-[var(--Color-Text-Text-Secondary)]">Find everything from cameras to cleaning tools — all in one place.</div>
            </div>
          </div>
          <div class="flex items-start gap-3">
            <i class="fa-solid fa-layer-group text-2xl text-[var(--Color-Text-Text-Brand)]"></i>
      ...
      <div class="container mx-auto px-4 py-10 flex flex-col md:flex-row md:justify-between gap-8">
        ...
        <div class="flex-1 max-w-xs">
          ...
          <div class="flex gap-2">
            <input type="email" placeholder="Enter your email" class="flex-1 px-3 py-2 rounded border border-[var(--Color-Boarder-Border-Primary)] bg-[var(--Color-Surface-Surface-Primary)] text-[var(--Color-Text-Text-Primary)] focus:outline-none" />
            <button class="px-4 py-2 rounded bg-[var(--Color-Surface-Surface-Brand)] text-[var(--Color-Text-Text-Invert)] font-semibold hover:bg-[var(--Color-Text-Text-Brand)] transition">Subscribe</button>
          </div>
